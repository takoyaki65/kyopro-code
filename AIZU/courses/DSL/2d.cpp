...
auto fa = [](X_type x, M_type m) -> X_type { return m; };
auto fm = [](M_type m1, M_type m2) -> M_type { return m2; };
...
int main() {
  int n, q;
  cin >> n >> q;
  vector<long long> v(n, numeric_limits<int>::max());
